...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='DCT-WFNet')
    ...
    parser.add_argument('--temporal_window', type=int, default=3, help='window size for temporal gating')
    ...
    parser.add_argument('--learning_rate', type=float, default=0.000105, help='optimizer learning rate')
    parser.add_argument('--des', type=str, default='test', help='exp description')
    parser.add_argument('--loss', type=str, default='MSE', help='loss function')
    parser.add_argument('--lradj', type=str, default='type1', help='adjust learning rate')
    parser.add_argument('--tib', type=int, default=1, help='type of Inception Block')
